...
type GLTFNodes = {
  ...
  Truck1: THREE.Mesh;
  Truck2: THREE.Mesh;
  [key: string]: THREE.Mesh; // Fallback for any other nodes
};
...
export function Skateboard({
  ...
  // Use more permissive type casting
  const gltf = useGLTF("/skateboard.gltf");
    ...
    () =>
      ({
        ...
        side: {
          ...
          position: [0, 0.295, 0] as [number, number, number],
        },
      }) as const,
    []
  );
